...
final class JWK
{
     ...
     */
    static
    public function createOctKey(): JoseJWK
    {
     ...
     */
    static
    public function createFromSecret(string $secret): JoseJWK
    {
     ...
     */
    static
    public function createRSAKey(): JoseJWK
    {
     ...
     */
    static
    public function createECKey(): JoseJWK
    {
     ...
     */
    static
    public function createOKPKey(): JoseJWK
    {
     ...
     */
    static
    public function createNoneKey(): JoseJWK
    {
